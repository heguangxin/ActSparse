...
from model_utils import SparseQwen2ForCausalLM
...
def main():
    ...
    model: SparseQwen2ForCausalLM = SparseQwen2ForCausalLM.from_pretrained(path, torch_dtype=torch.bfloat16).cuda()
